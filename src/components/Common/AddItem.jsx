...
const AddItem = () => {
  ...
  return (
    ...
    // //* [Modified Code] Height Sync: Item.jsx와 동일하게 min-h-[25vh] 및 h-auto 적용하여 높이 동기화
    <div className="add-card item w-full md:w-1/2 lg:w-1/3 h-auto min-h-[25vh] p-[0.25rem]">
